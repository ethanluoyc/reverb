...
load("//reverb/pip_package:reverb_version.bzl", "VERSION", "VERSION_SUFFIX")

WHEEL_NAME = "dm_reverb"
...
def _tf_wheel_impl(ctx):
    ...
    full_wheel_version = (VERSION + VERSION_SUFFIX)
...
def tf_wheel_dep():
    return ["@pypi//{}:pkg".format(WHEEL_NAME)]
